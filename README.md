...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-24 01:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f8255572-873e-4a6e-bce1-02a4acaaabcf.git
$ cd f8255572-873e-4a6e-bce1-02a4acaaabcf
```
